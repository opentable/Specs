...
This library contains an abstraction layer for all tracking providers used by OpenTable.
  ...
  s.dependency    'Mixpanel-OpenTable', '~> 2.7.0'
  s.dependency    'MobileAppTracker', '~> 3.5.0'
  s.dependency    'Omnivore-OT', '~> 1.0.0'
  s.prefix_header_file = "OTTracking/Supporting Files/OTTracking-Pods-Prefix.h"
  s.module_name = "OTTracking"

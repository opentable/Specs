...
DESC
  ...
  s.dependency    'AFNetworking-OpenTable', '~> 2.4.1'
  s.dependency	  'CocoaLumberjack', '~> 1.9.0'
  s.dependency    'CocoaAsyncSocket-OT', '~> 7.4.0'

  s.frameworks	  = 'CoreText', 'SystemConfiguration', 'MobileCoreServices', 'Accelerate'
  s.frameworks    = 'PassKit'

  s.public_header_files = 'OTFoundation/**/*.h'
  s.prefix_header_file = "OTFoundation/Classes/OTFoundation-Pods-Prefix.h"
  s.module_name = "OTFoundation"
